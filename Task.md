...
| 6    | DNS Verification                     | Capture a screenshot of the public DNS of the load balancer when traffic is sent from a browser, showing it returns content from the private # Terraform EC2 and Load Balancer Deployment
This document serves as a comprehensive guide for anyone want to creat and deploy this project. Whether you are a seasoned Devops eng or just starting your journey in cloud infrastructure, this project is designed to enhance your understanding of AWS and Terraform. 
## Project Overview
| Description           | Details                                    |
|-----------------------|--------------------------------------------|
...
### Additional Insights
- 
EC2 instances. |# Terraform EC2 and Load Balancer Deployment
This document serves as a comprehensive guide for anyone want to creat and deploy this project. Whether you are a seasoned Devops eng or just starting your journey in cloud infrastructure, this project is designed to enhance your understanding of AWS and Terraform. 
## Project Overview
| Description           | Details                                    |
|-----------------------|--------------------------------------------|
